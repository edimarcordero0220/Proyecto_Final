<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RVentas.aspx.cs" Inherits="GestionDeVentas.Registros.RVentas" %>
            ...
            <div class="form-horizontal col-md-12" role="form">
               ...
               <%-- Input ID--%>
                <div class="form-group">
                    ...
                    <div class="col-md-1 col-sm-2 col-xs-4">
                        <asp:Button ID="BuscarButton" CssClass="btn btn-info btn-block btn-md" runat="server" Text="Busca" OnClick="BuscarButton_Click" />
              ...
              <%--  Input Concepto--%>
                ...
                <div class="form-group">
                    <label for="IdTextBox" class="col-md-3 control-label input-sm">(*) Total: </label>
                    <div class="col-md-1 col-sm-2 col-xs-4"> 
