<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cDetalleVendedor.aspx.cs" Inherits="GestionDeVentas.Consultas.cDetalleVendedor" %>
        ...
        <div class="panel-body">
            <div class="auto-style1" role="form">
                ...
                <asp:TextBox ID="BuscarTextBox" runat="server" Width="151px"></asp:TextBox>
                    ...
                    <asp:button runat="server" class="btn btn-info" text="Buscar" ID="BuscarButton" OnClick="BuscarButton_Click" />
