<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cCuadreVendedor.aspx.cs" Inherits="GestionDeVentas.Consultas.cCuadreVendedor" %>
        ...
        <div class="panel-body">
            <div class="auto-style1" role="form">
                ...
                <asp:TextBox ID="BuscarTextBox" runat="server" Width="151px"></asp:TextBox>
                    <asp:Button ID="BuscarButton" runat="server" class="btn btn-info" Text="Filtrar" OnClick="BuscarButton_Click" />
